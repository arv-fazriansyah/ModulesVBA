...
Sub GetVisible(control As IRibbonControl, ByRef MakeVisible)
    ...
    Select Case control.ID
        ...
        Case "customGroup1":            MakeVisible = ws.Range("L27").value
        Case "customGroup2":            MakeVisible = ws.Range("L28").value
        Case "customGroup3":            MakeVisible = ws.Range("L29").value
        Case "customGroup4":            MakeVisible = ws.Range("L30").value
        Case "customGroup5":            MakeVisible = ws.Range("L31").value
        Case "customGroup6":            MakeVisible = ws.Range("L32").value
        
        Case "Dash":                    MakeVisible = ws.Range("L33").value
        Case "Update":                  MakeVisible = ws.Range("L34").value
        Case "Upload":                  MakeVisible = ws.Range("L35").value
        Case "PetaBenahi":              MakeVisible = ws.Range("L36").value
